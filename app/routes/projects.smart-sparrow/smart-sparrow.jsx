...
const title = 'Rishource: Scalable Discord Ecosystem & Management Platform';
const description =
  'Rishource is an advanced Discord automation system and full-stack web platform built for high-concurrency communities. Engineered with Python, discord.py AutoShardedBot, Next.js, PostgreSQL with Prisma ORM, a 15-minute Node-Cache TTL, and OpenAI integrations.';
const roles = [
  'Systems Architecture',
  'Discord API & Bot Engineering',
    ...
    <>
      <ProjectContainer>
        ...
        <ProjectHeader
          ...
          linkLabel="View Platform Source"
        ...
        <ProjectSection padding="top">
          <ProjectSectionContent>
            <ProjectImage
              ...
              alt="Rishource centralized administration interface and guild control overview."
            />
          </ProjectSectionContent>
        </ProjectSection>
        <ProjectSection>
          <ProjectTextRow>
            <ProjectSectionHeading>The Architectural Problem</ProjectSectionHeading>
            <ProjectSectionText>
              Modern community servers demand real-time moderation, automated role assignments, custom ticket workflows, and instant support without server-side lag or gateway disconnects. Standard single-process bots quickly degrade under Discord API rate limits and spikes in WebSocket gateway traffic. The goal was to architect an enterprise-ready system capable of serving thousands of users across independent guilds while maintaining continuous uptime, resilient caching, and modular extensibility.
            </ProjectSectionText>
          </ProjectTextRow>
        </ProjectSection>
        <ProjectSection light={isDark}>
          <ProjectSectionContent>
            ...
            <ProjectTextRow>
              <ProjectSectionHeading>Modular Cog Architecture</ProjectSectionHeading>
              <ProjectSectionText>
                To decouple features and isolate system failures, Rishource is organized around an asynchronous Cog system. Core functionality—such as moderation audit logs, support ticketing, leveling systems, and OpenAI chat completions—are divided into autonomous classes inheriting from discord.py’s Cog pattern. Each Cog can be hot-reloaded dynamically during runtime without severing the active gateway socket.
              </ProjectSectionText>
            </ProjectTextRow>
          </ProjectSectionContent>
        </ProjectSection>
        <ProjectSection>
          <ProjectSectionContent>
            <Image
              ...
              alt="Rishource centralized administration dashboard interface and configuration views."
              sizes="100vw"
            />
            <ProjectTextRow>
              <ProjectSectionHeading>15-Minute Node-Cache &amp; 429 Graceful Degradation</ProjectSectionHeading>
              <ProjectSectionText>
                Managing hundreds of guild metadata queries simultaneously risked exhausting Discord API rate limits (HTTP 429). Rishource implements a 15-minute TTL memory cache (Node-Cache) alongside token-bucket throttling. On rate-limit triggers, the system gracefully serves cached state to the Next.js administration portal, ensuring uninterrupted operator control.
              </ProjectSectionText>
            </ProjectTextRow>
          </ProjectSectionContent>
        </ProjectSection>
          ...
          <ProjectSection
            ...
            backgroundElement={
              <Image
                ...
                alt="Rishource distributed server network background visualization."
                sizes="100vw"
              />
            }
          >
            <ProjectSectionColumns width="full">
              <ProjectSectionContent width="full">
                <ProjectTextRow width="s">
                  <ProjectSectionHeading>Sharded Gateway Scaling</ProjectSectionHeading>
                  <ProjectSectionText>
                    As guild count expands, Discord requires bots to partition event dispatching across shards. Rishource leverages an AutoShardedBot architecture, distributing load across independent shard clusters to guarantee low latency dispatch and resilient connection recovery.
                  </ProjectSectionText>
                </ProjectTextRow>
              </ProjectSectionContent>
              <Image
                ...
                alt="Interactive bot telemetry and command execution demonstration."
        ...
        <ProjectSection>
          <ProjectSectionContent>
            <ProjectTextRow>
              <ProjectSectionHeading>Intelligent OpenAI Workflows</ProjectSectionHeading>
              <ProjectSectionText>
                Rishource embeds conversational intelligence directly into community channels. By orchestrating prompt context, user query sanitization, and structured OpenAI completions, the assistant provides automated code explanations, contextual help, and server moderation insights.
              </ProjectSectionText>
            </ProjectTextRow>
            <Image
              raised
              ...
              alt="Rishource workflow automation editor and rule configuration."
        ...
        <ProjectSection>
          <ProjectSectionColumns>
            <ProjectSectionContent>
              <ProjectTextRow>
                <ProjectSectionHeading>
                  PostgreSQL Persistence &amp; Prisma Data Layer
                </ProjectSectionHeading>
                <ProjectSectionText>
                  Server settings, role permissions, custom command aliases, and member infractions are persisted in PostgreSQL. Using Prisma ORM provides compile-time TypeScript type safety across queries, migrations, and async connection pool operations.
                </ProjectSectionText>
              </ProjectTextRow>
            </ProjectSectionContent>
        ...
        <ProjectSection>
          <ProjectSectionContent>
            <ProjectTextRow center centerMobile noMargin>
              ...
              <ProjectSectionHeading>Platform Impact &amp; Results</ProjectSectionHeading>
              <ProjectSectionText>
                Rishource was deployed into production across active Discord servers, handling high transaction volumes with zero unhandled downtime. The combination of sharded socket connections, local memory caching, and Prisma PostgreSQL storage reduced response latency by over 65% and completely eliminated rate-limit throttling during peak community events.
              </ProjectSectionText>
            </ProjectTextRow>
          </ProjectSectionContent>
        </ProjectSection>
